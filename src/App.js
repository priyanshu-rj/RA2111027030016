    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`http://20.244.56.144/test/${type}`, {
          headers: {
            'Authorization': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..tBCGvw-7fCi5a9CtAKwA5WcwBO6yK4vJsxbvT_wuilY'  // token is changed for every request
          }
        });
        if (!response.ok) {
